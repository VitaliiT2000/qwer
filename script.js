...
const messages = ["С начала", "Сейчас будет стих", "И так", "ахахах не будет", "я просто его не тут напишу", "Но скажу, что люблю тебя очень", "ТЫ самая лучшая девочка на свете!", 
    ...
    "Потому что я надеюсь", "ты будешь смотреть это не только сейчас", "конечно же, пока я не сделаю лучше)","потом будешь другим моим творчеством любоваться", "Я ТЕБЯ ЛЮБЛЮ! 💛💛💛", "Атеперь все..."
];
let currentIndex = 0;
